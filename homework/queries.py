...
def run():
    ...
    # Query 1: SELECT *, tip/total_bill as tip_rate
    run_mapreduce_job(
    ...
    # Query 2: SELECT * FROM tips WHERE time = 'Dinner'
    run_mapreduce_job(
    ...
    # Query 3: SELECT * FROM tips WHERE time = 'Dinner' AND tip > 5.00
    run_mapreduce_job(
    ...
    # Query 4: SELECT * FROM tips WHERE size >= 5 OR total_bill > 45
    run_mapreduce_job(
    ...
    # Query 5: SELECT sex, count(*) GROUP BY sex
    run_mapreduce_job(
